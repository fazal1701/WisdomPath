...
export const mockConditions: Condition[] = [
  ...
  },
  {
    ...
    description: 'Chronic inflammatory lung disease that causes obstructed airflow from the lungs.',
    approaches: [
      {
        tradition: 'western',
        traditionName: 'Western Medicine',
        diagnosis: 'COPD',
        approach: 'Bronchodilators and steroids.',
        treatments: [
          { name: 'Albuterol', type: 'drug', description: 'Short-acting bronchodilator.', safetyLevel: 'safe', safetyNote: 'May cause tremors.' },
          { name: 'Tiotropium (Spiriva)', type: 'drug', description: 'Long-acting bronchodilator.', safetyLevel: 'safe', safetyNote: 'Dry mouth.' }
        ],
        evidenceLevel: 5, evidenceType: 'Guidelines'
      }
    ],
    aiSynthesis: 'Smoking cessation is critical.',
    escalationTriggers: ['Respiratory Failure']
  },
  {
    id: 'cond-032',
    ...
    approaches: [
      {
        ...
        traditionName: 'Western Medicine',
        diagnosis: 'AFib',
        approach: 'Rate control and anticoagulation.',
        treatments: [
          { name: 'Metoprolol', type: 'drug', description: 'Beta-blocker.', safetyLevel: 'safe', safetyNote: 'Fatigue.' },
          { name: 'Warfarin', type: 'drug', description: 'Anticoagulant.', safetyLevel: 'risk', safetyNote: 'Bleeding risk.' }
        ],
        evidenceLevel: 5, evidenceType: 'Guidelines'
      }
    ],
    aiSynthesis: 'Prevents stroke.',
    escalationTriggers: ['Stroke symptoms']
  },
  {
    id: 'cond-033',
    ...
    approaches: [
      {
        ...
        traditionName: 'Western Medicine',
        diagnosis: 'Crohn\'s',
        approach: 'Anti-inflammatories.',
        treatments: [
          { name: 'Prednisone', type: 'drug', description: 'Corticosteroid.', safetyLevel: 'caution', safetyNote: 'Long term side effects.' },
          { name: 'Adalimumab (Humira)', type: 'drug', description: 'Biologic.', safetyLevel: 'caution', safetyNote: 'Infection risk.' }
        ],
        evidenceLevel: 5, evidenceType: 'Guidelines'
      }
    ],
    aiSynthesis: 'Dietary management.',
    escalationTriggers: ['Bowel obstruction']
  },
  {
    id: 'cond-034',
    name: 'Multiple Sclerosis',
    description: 'Autoimmune disease of CNS.',
    approaches: [
      {
        tradition: 'western',
        traditionName: 'Western Medicine',
        diagnosis: 'MS',
        approach: 'Disease modification.',
        treatments: [
          { name: 'Interferon beta-1a', type: 'drug', description: 'Immunomodulator.', safetyLevel: 'caution', safetyNote: 'Flu-like symptoms.' }
        ],
        evidenceLevel: 5, evidenceType: 'Guidelines'
      }
    ],
    aiSynthesis: 'Physical therapy.',
    escalationTriggers: ['Relapse']
  },
  {
    id: 'cond-035',
    ...
    approaches: [
      {
        ...
        approach: 'Dopamine replacement.',
        treatments: [
          { name: 'Levodopa/Carbidopa', type: 'drug', description: 'Dopamine precursor.', safetyLevel: 'safe', safetyNote: 'Dyskinesia.' }
        ],
        evidenceLevel: 5, evidenceType: 'Guidelines'
      }
    ],
    aiSynthesis: 'Exercise.',
    escalationTriggers: ['Freezing episodes']
  }
];
